...
public class StudentTaskProgressController {

    private final StudentTaskProgressService studentTaskProgressService;
    ...
    public ResponseEntity<ApiResponseDTO<StudentTaskProgressResponse>> createStudentTaskProgress(@RequestBody @Valid StudentTaskProgressRequest request) {
        StudentTaskProgressResponse response = studentTaskProgressService.createStudentTaskProgress(request);
    ...
    public ResponseEntity<ApiResponseDTO<ListWrapper<StudentTaskProgressResponse>>> getProgressedTasksByStudentId(@PathVariable Integer studentId) {
        List<StudentTaskProgressResponse> tasks = studentTaskProgressService.getProgressedTasksByStudentId(studentId);
    ...
    public ResponseEntity<ApiResponseDTO<StudentTaskProgressResponse>> updateProgress(@PathVariable Integer id, @RequestBody @Valid StudentTaskProgressUpdateRequest request) {
        StudentTaskProgressResponse response = studentTaskProgressService.updateProgress(id, request.getProgress());
